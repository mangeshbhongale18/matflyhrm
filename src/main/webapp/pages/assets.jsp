            ...
            <div class="content">
                <form action="saveassets" method="post" >
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            <span class="details">Asset Category</span>
                            <input type="text" name="assetc" placeholder="e.g Technical, Personal, Travel, etc." required>
                        </div>
                        <div class="input-box">
                        <span class="details">Asset Description</span>
                        <textarea name="assetdesc" cols="50" rows="4" placeholder="Enter a description of the asset" required></textarea>
                        </div>
                    ...
                    <div class="button">
                        <input type="submit" value="Request for Assets">
                    </div>
...
<script>
  const assetssaved = ${assetssaved};  // This gets the boolean value from the model
  ...
  if (assetssaved) {
	  Swal.fire({
	      ...
	      title: 'Congratulations!<br> Your Request has been sent successfully',
