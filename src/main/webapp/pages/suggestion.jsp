...
<body>
	...
	<div class="dashmain">
		...
		<div class="container">
			...
			<div class="content">
				<form action="savesuggestion" method="post">
					<div class="user-details">
						...
						<div class="input-box">
							<span class="details">Suggestion Topic</span> <input type="text"
								name="suggestiontitile"
								placeholder="Enter topic title of your idea" required>
						</div>
						<div class="input-box">
							<span class="details">Suggestion Description</span>
							<textarea name="suggestiondesc" cols="50" rows="4"
								placeholder="Explain suggestion in detail" required></textarea>
						</div>
					...
					<div class="button">
						<input type="submit" value="Sumbit your Suggestion">
					</div>
