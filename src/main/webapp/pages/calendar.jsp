...
<body>
	...
	<div class="sidewrapper">
		...
		<div class="navitems">
			<ul class="nav-list">
				...
				<li class="active"><a href="calendar"><img
	...
	<div class="dashmain">
			...
			<header>
				...
				<div class="colorindiacator">
					<p style="cursor: pointer;">
						<i style="color: #ffa500;" class="fa-solid fa-square"></i>Today
					</p>

					<p>
						<i style="color: #fe0466;" class="fa-solid fa-square"></i>Holiday
					</p>
				</div>
				<div class="icons">
		...
		<div style="display: none" class="holidaylist">
			<ul>
				<c:forEach items="${data}" var="holiday">
					<ul>
						<li class="holidaydate">${holiday.date}</li>
						<li class="holidayreason">${holiday.holiday}</li>
					</ul>
