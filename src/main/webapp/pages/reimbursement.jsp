...
<link rel="stylesheet" href="css/reimbursemet.css">
...
<body>
	...
	<div class="dashmain">
		...
		<div class="container">
			<div class="title">
				<h1>Expense Reimbursement Request Form</h1>
				<img src="images/Matfly Digital logo.png" alt="">
			</div>
			<div class="content">
				<form action="savereimbursement" method="post"
					...
					<div class="user-details">
						...
						<div class="input-box">
							<span class="details">Expense Amount</span> <input type="text"
								name="amount" placeholder="Enter the Expense Amount" required>
						</div>
						<div class="input-box">
						...
						<div class="input-box">
							<span class="details">Expense Date</span>
						...
						<div class="input-box">
							<span class="details">Expense Category</span> <input type="text"
								name="ecategory" placeholder="e.g Lunch, Dinner, Travel, etc"
								required>
						</div>
						<div class="input-box">
							<span class="details">Expense Receipt</span> <input type="file"
								id="expense-receipt" name="file"
								accept=".pdf, image/*, .doc, .docx" required>


						</div>
						<div class="input-box">
							<span class="details">Submission Date</span> <input type="date"
								name="sdate" placeholder="" required>
						</div>
